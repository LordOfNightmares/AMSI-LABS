...
%----------------------------------------------------------------------------------------
  ...
  \textsc{\Large AMSI}\\[0.5cm] % Major heading such as course name
...
\newcommand{\HRule}{\rule{\linewidth}{0.5mm}} % Defines a new command for the horizontal lines, change thickness here
 ...
 Modeling your project with Sequence Diagrams. Functional and Non-Functional Requirements. }\\[0.4cm] % Title of your document
  \HRule \\[1.0cm]
